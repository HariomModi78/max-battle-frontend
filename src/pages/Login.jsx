    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 to-secondary-100 flex items-center justify-center px-4 py-8">
      <div className="max-w-md w-full mx-auto">
        ...
        <div className="text-center mb-6 md:mb-8">
          ...
          <h1 className="text-2xl md:text-3xl font-bold text-secondary-900 mb-2">Welcome Back</h1>
          <p className="text-secondary-600 text-sm md:text-base">Sign in to continue to Max Battle</p>
        </div>
